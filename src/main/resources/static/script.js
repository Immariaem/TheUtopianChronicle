...
const itemIcons = {
    ...
    'Coral Relic': '<svg viewBox="0 0 16 16" class="slot-item-icon"><rect x="6" y="4" width="4" height="8" fill="#f97316"/><rect x="5" y="5" width="6" height="6" fill="#ea580c"/><rect x="7" y="3" width="2" height="2" fill="#fb923c"/><rect x="7" y="6" width="2" height="2" fill="#fdba74"/></svg>',
    'Pearl Relic': '<svg viewBox="0 0 16 16" class="slot-item-icon"><rect x="5" y="4" width="6" height="8" fill="#d4d4d8"/><rect x="4" y="5" width="8" height="6" fill="#e4e4e7"/><rect x="6" y="5" width="2" height="2" fill="#fafafa"/><rect x="9" y="8" width="2" height="2" fill="#a1a1aa"/></svg>',
    'Stone Relic': '<svg viewBox="0 0 16 16" class="slot-item-icon"><rect x="5" y="4" width="6" height="8" fill="#57534e"/><rect x="4" y="5" width="8" height="6" fill="#78716c"/><rect x="6" y="6" width="4" height="1" fill="#a8a29e"/><rect x="6" y="9" width="4" height="1" fill="#a8a29e"/></svg>'
};
